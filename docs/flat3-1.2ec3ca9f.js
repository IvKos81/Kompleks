...
},{}],"ZP6N":[function(require,module,exports) {
"use strict";
...
var balcony = document.querySelector('#balcony');
var bedroom1 = document.querySelector('#bedroom1');
var bedroom2 = document.querySelector('#bedroom2');
...
bedroom1.addEventListener('mouseover', function (evt) {
  flDescr.style.display = 'block';
...
bedroom1.addEventListener('mouseleave', function (evt) {
  flDescr.style.display = 'none';
});
bedroom2.addEventListener('mouseover', function (evt) {
  flDescr.style.display = 'block';
...
bedroom2.addEventListener('mouseleave', function (evt) {
  flDescr.style.display = 'none';
});
...
},{"./flat.scss":"ejtM","./template/header.scss":"X9Zt","./template/footer.scss":"ng52","./animation.scss":"WpEu","./animation.js":"PpqJ"}]},{},["ZP6N"], null)
//# sourceMappingURL=flat3-1.2ec3ca9f.js.map