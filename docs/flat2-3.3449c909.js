...
},{}],"iKIG":[function(require,module,exports) {
"use strict";
...
bedroom.addEventListener('mouseover', function (evt) {
  flDescr.style.display = 'block';
...
bedroom.addEventListener('mouseleave', function (evt) {
  flDescr.style.display = 'none';
});
...
},{"./flat.scss":"ejtM","./template/header.scss":"X9Zt","./template/footer.scss":"ng52","./animation.scss":"WpEu","./animation.js":"PpqJ"}]},{},["iKIG"], null)
//# sourceMappingURL=flat2-3.3449c909.js.map